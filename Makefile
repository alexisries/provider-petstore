...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider PetStore CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider PetStore controllers
...
# This target prepares repo for your provider by replacing all "petstore"
